        ...
        <div className={"row justify-content-center "}>
          ...
          >
            <div className={"wrapperCol"}>
              ...
              <button className={"button common-btn mx-auto my-2 my-lg-5"}>
                Request Demo ›
              </button>
            </div>
          </div>
          <div className={"col-12 col-md-10 col-lg-6 p-40 border-left"}>
            <div className={"wrapperCol justify-content-center"}>
              <img className={"bg-img rotation-animation"} src={glowImage} alt="glow"/>
              <img src={sonosImage} className={"center-img bonos"} alt="bonos"/>
            </div>
          </div>
        </div>
      </div>
